...
namespace CollectionTrackerAPI.Migrations
{
    public partial class InitialDatabaseMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CollectionId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ArticleName = table.Column<string>(maxLength: 250, nullable: false),
                    AcquisitionDate = table.Column<DateTime>(nullable: false),
                    ArticleCost = table.Column<double>(nullable: false),
                    ConditionId = table.Column<int>(nullable: false),
                    FabricationDate = table.Column<DateTime>(nullable: false),
                    CategoryId = table.Column<int>(nullable: true),
                    BrandId = table.Column<int>(nullable: true),
                    Description = table.Column<string>(maxLength: 250, nullable: true),
                    CollectionUserId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Collections_AspNetUsers_CollectionUserId",
                        column: x => x.CollectionUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Collections_Conditions_ConditionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Collections_CollectionUserId",
                table: "Collections",
                column: "CollectionUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Collections_ConditionId",
                table: "Collections",
                column: "ConditionId");
        }
